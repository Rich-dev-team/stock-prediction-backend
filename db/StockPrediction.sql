...
ALTER TABLE "stock_price" ADD FOREIGN KEY ("company_id") REFERENCES "company" ("id");

ALTER TABLE "balance_sheet" ADD FOREIGN KEY ("company_id") REFERENCES "company" ("id");

ALTER TABLE "cash_flow" ADD FOREIGN KEY ("company_id") REFERENCES "company" ("id");

ALTER TABLE "stock_policy" ADD FOREIGN KEY ("company_id") REFERENCES "company" ("id");

ALTER TABLE "composite_income_sheet" ADD FOREIGN KEY ("company_id") REFERENCES "company" ("id");

ALTER TABLE "month_income_sheet" ADD FOREIGN KEY ("company_id") REFERENCES "company" ("id");
